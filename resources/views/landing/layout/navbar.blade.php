...
<div class="container-fluid p-0">
    <nav id="mainNavbar" class="navbar navbar-expand-lg bg-white navbar-light py-1 shadow-sm">
        <div class="container">
            <!-- Logo -->
            <a href="{{ url('/') }}" class="navbar-brand">
                <img src="{{ asset('/assets2/img/logo.png') }}" alt="GenZE Logo" style="height: 45px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    @auth
                        @php
                            ...
                            $dashboardUrl = match($role) {
                                'user' => url('/siswa/dashboard'),
                                'mentor' => url('/mentor/dashboard'),
                                'admin' => url('/admin/dashboard'),
                                default => '#'
                            };
                        @endphp
                        <a href="{{ $dashboardUrl }}" class="nav-item nav-link {{ request()->is('siswa/dashboard') || request()->is('mentor/dashboard') || request()->is('admin/dashboard') ? 'active' : '' }}">
                            Dashboard
                        </a>
                    @endauth
                </div>
                ...
                @auth
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="userDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ url('/siswa/status-pendaftaran') }}"><i class="fas fa-history me-2 text-warning"></i> Riwayat Pendaftaran</a></li>
                            <li><a class="dropdown-item" href="{{ url('/siswa/testimonial/create') }}"><i class="fas fa-pencil-alt me-2 text-dark"></i> Testimonial</a></li>
                ...
                @else
                    <a href="#" class="btn btn-primary px-4 ms-lg-3" data-bs-toggle="modal" data-bs-target="#loginModal">Login</a>
                @endauth
            </div>
        </div>
    </nav>
