    ...
    <div class="row align-items-center">
        <div class="col-lg-6 mb-4 mb-lg-0">
            <div class="rounded overflow-hidden shadow-sm" style="max-height: 400px;">
                <img src="{{ asset('assets2/img/home2.jpeg') }}" class="img-fluid w-100 h-100" style="object-fit: cover;" alt="About GenZE">
            </div>
        </div>
        <div class="col-lg-6">
...
<div class="owl-carousel mentor-carousel px-3">
...
<div class="container-fluid py-5 bg-white">
    <div class="container py-5">
        ...
        <div class="owl-carousel blog-carousel px-3">
            @foreach($blogs as $blog)
            <div class="item">
                <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden transition hover-zoom">
                    ...
                    <div class="card-body px-3 py-4 ">
                        ...
                        <div class="mb-2 text-muted small">
                            ...
                            <i class="fa fa-user me-1"></i> {{ $blog->user->name }} |
                            <i class="fa fa-folder-open me-1"></i> {{ $blog->kategoriBlog->kategori_blog ?? 'Uncategorized' }}
                        </div>
                        <p class="text-muted small">{{ Str::limit(strip_tags($blog->isi), 70) }}</p>
                        <div class="card-footer bg-white border-0 text-center ">
                        <a href="{{ route('landing.page.detail-blog', $blog->id_blog) }}"
                           class="btn btn-outline-success btn-sm px-4 rounded-pill fw-semibold">
...
<div class="container-fluid py-5 bg-light">
    <div class="container py-5">
        ...
        <div class="text-center mb-5">
            ...
            <h2 class="display-5 font-weight-bold text-dark">Apa Kata Siswa Kami?</h2>
            <p class="text-muted mx-auto" style="max-width: 600px;">
        ...
        @endforeach
            ...
            <div class="col-lg-5">
                @if($testimonials->count())
                    <div class="owl-carousel testimonial-carousel px-1">
                ...
                @else
                    <p class="text-muted text-center">Belum ada testimonial saat ini.</p>
                @endif
            </div>
        </div>
    </div>
...
<div class="container-fluid py-5">
    ...
    <div class="container">
        <div class="owl-carousel owl-theme partner-carousel px-2">
            @foreach($mediaPartners as $partner)
            <div class="item text-center">
                <img src="{{ asset('storage/' . $partner->logo) }}"
                     alt="{{ $partner->nama }}"
                     class="img-fluid partner-logo mx-auto">
            </div>
            @endforeach
        </div>
    </div>
